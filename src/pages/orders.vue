<template>
    ...
    <v-row>
        <v-col>
            <v-text-field v-model="orderNumber" density="compact" placeholder="Order Number" hide-details></v-text-field>
        </v-col>
        <v-col>
            <v-select
                v-model="orderYear"
        ...
        <v-col>
            <v-select
                v-model="orderStatus"
                :items="['All', 'Shipped', 'In Process', 'Cancelled', 'Resolved']"
                density="compact"
        ...
        <v-col>
            <v-text-field v-model="customerName" density="compact" placeholder="Customer Name" hide-details></v-text-field>
        </v-col>
        <v-col>
            <v-btn 
                color="primary" 
